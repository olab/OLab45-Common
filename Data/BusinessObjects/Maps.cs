...
public partial class Maps
{
  ...
  [Column( "startScore", TypeName = "int(11)" )]
  public int StartScore { get; set; }

  [Column( "threshold", TypeName = "int(11)" )]
  ...
  [Column( "delta_time", TypeName = "int(11)" )]
  ...
  [Column( "reminder_time", TypeName = "int(11)" )]
  ...
  [Column( "assign_forum_id", TypeName = "int(11)" )]
  public int? AssignForumId { get; set; }

  [Column( "author_rights", TypeName = "int(11)" )]
  ...
  [Column( "is_template", TypeName = "int(11)" )]
  ...
  [Column( "report_node_id", TypeName = "int(11)" )]
