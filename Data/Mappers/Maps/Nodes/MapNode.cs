...
public class MapNodesMapper : OLabMapper<Model.MapNodes, MapNodesDto>
{
  ...
  public override Model.MapNodes ElementsToPhys(IEnumerable<dynamic> elements, Object source = null)
  {
    ...
    phys.IsEnd = Convert.ToInt32( elements.FirstOrDefault( x => x.Name == "end" ).Value ) == 1 ? true : false;
    ...
    phys.IsKfp = Convert.ToInt32( elements.FirstOrDefault( x => x.Name == "kfp" ).Value ) == 1 ? true : false;
    ...
    phys.IsProbability = Convert.ToInt32( elements.FirstOrDefault( x => x.Name == "probability" ).Value ) == 1 ? true : false;
    ...
    phys.IsUndo = Convert.ToInt32( elements.FirstOrDefault( x => x.Name == "undo" ).Value ) == 1 ? true : false;
